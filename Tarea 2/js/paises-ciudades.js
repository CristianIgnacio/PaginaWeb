...
paisCapital.set('Zimbabue', 'Harare');
    ...
    var selectElement1 = document.getElementById('pais-origen');

    for ( const x of paisCapital.keys()) {
        selectElement1.add(new Option(x));
    }

    var selectElement2 = document.getElementById('ciudad-origen');

    for ( const x of paisCapital.values()) {
        selectElement2.add(new Option(x));
    }

    var selectElement3 = document.getElementById('pais-destino');

    for ( const x of paisCapital.keys()) {
        selectElement3.add(new Option(x));
    }

    var selectElement4 = document.getElementById('ciudad-destino');

    for ( const x of paisCapital.values()) {
        selectElement4.add(new Option(x));
    }
